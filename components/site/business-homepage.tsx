...
import { company, process, services, stats } from "@/data/site-content";
...
import {
  ...
  SectionTitle,
  SiteFooter,
} from "@/components/site/business-homepage-sections";
            ...
            {works.map((work, index) => {
              ...
              return (
                <PortfolioCard
                  ...
                  linkedProductSlug={linkedProduct?.slug}
                />
              );
            })}
          </div>
        ...
        <Container className="relative z-10 grid items-center gap-16 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <p className="mt-6 text-lg leading-relaxed text-slate-400">
              MATOSHREE ENGINEERING follows a proven four-step process to deliver fabrication and signage
              solutions that meet your exact requirements and safety standards.
            </p>
          </div>
